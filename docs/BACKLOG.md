...
|----|------------|----------|--------|--------|-------|
| US-01 | As a visitor, I want to register an account... | High | 3 | Design Defined | See use-cases.md, design/ |
| US-02 | As a registered user, I want to log in... | High | 5 | Design Defined | See use-cases.md, design/ |
| US-03 | As an author, I want to write and publish... | High | 5 | Requirements Defined | Scope negotiated: plain text only, see Section 5.4. Design comes in Lecture 6 |
| US-04 | As a reader, I want to browse a public feed... | High | 3 | Design Defined | See use-cases.md, design/ |
